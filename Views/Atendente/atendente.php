...
<div class="area-cad">
    ...
    <div class="singIn p-2">
        ...
        <form class="row d-flex flex-row was-validated" action="/atendentes/save" method="POST">
            <div class="h4 title-cad ">ATENDENTES</div>
            <input type="hidden" name="id" value="<?= $modelAtendente->id ?>">
            <div class="col-md">
                <div class="input-group mb-3">
                    <div class="form-floating">
                        <input type="text" name="nome" class="form-control" placeholder="NOME" aria-label="NOME" value="<?= $modelAtendente->nome ?>" aria-describedby="addon-wrapping" autofocus required>

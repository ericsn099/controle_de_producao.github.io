...
<div class="area-cad">
    ...
    <div class="h4 title-cad ">PRODUTOS</div>
        ...
        <table class="table table-striped " id="tableProduto"> 
            <thead>
                <tr>
                    <th>C&Oacute;DIGO</th>
                    <th>NOME</th>
            ...
            <tbody>
                <?php foreach ($modelProduto->rows as $item) : ?>
                    <tr>
                        ...
                        <td><?= $item->nome ?></td>
                        <td><a href="/produtos?id=<?= $item->id ?>" class="link-primary">ATUALIZAR</a></td>
    ...
    function confirmacao(id) {
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result === true) {
                    window.location.href = "/produtos/delete?id=" + id;
